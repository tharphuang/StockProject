...
class handleCsv():
    ...
    def top_ten_by_range_r(sub_li):
        ...
        跌幅排名
        """
        sub_li.sort(key=lambda x: float(x[3]),reverse=False)
        return sub_li[0:10]
        ...
        for i in range(0, len(r_flatten_list), group_step):
            ...
            if r.status_code == 200:
                ...
                for line in split_lines_list:
                    ...
                    # 格式： var hq_str_s_sz000063="中兴通讯,29.20,-0.14,-0.48,2355035,675174"
                    # 分离等号后面的字段
                    ...
                    if len(right_str) > 0:
                        ...
                        stock_field_list[3] = round(float(stock_field_list[3]), 2)
...
'''if __name__ == '__main__':
    ...
    CSV_PATH = "stock_index/stock.csv"
